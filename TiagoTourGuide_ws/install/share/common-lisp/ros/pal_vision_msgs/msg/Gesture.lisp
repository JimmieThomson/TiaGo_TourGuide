...
(cl:defmethod cl:initialize-instance :after ((m <Gesture>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Gesture)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pal_vision_msgs-msg:<Gesture> is deprecated: use pal_vision_msgs-msg:Gesture instead.")))
...
(cl:defmethod gestureId-val ((m <Gesture>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pal_vision_msgs-msg:gestureId-val is deprecated.  Use pal_vision_msgs-msg:gestureId instead.")
  (gestureId m))

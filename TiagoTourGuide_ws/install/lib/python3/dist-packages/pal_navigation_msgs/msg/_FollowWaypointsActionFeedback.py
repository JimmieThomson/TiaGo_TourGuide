...
"""autogenerated by genpy from pal_navigation_msgs/FollowWaypointsActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class FollowWaypointsActionFeedback(genpy.Message):
  _md5sum = "cfdf685ea10b1f82987074f454861557"
  _type = "pal_navigation_msgs/FollowWaypointsActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','pal_navigation_msgs/FollowWaypointsFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.feedback is None:
        self.feedback = pal_navigation_msgs.msg.FollowWaypointsFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = pal_navigation_msgs.msg.FollowWaypointsFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.feedback.current_waypoint
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.feedback.current_waypoint,) = _get_struct_I().unpack(str[start:end])
      return self

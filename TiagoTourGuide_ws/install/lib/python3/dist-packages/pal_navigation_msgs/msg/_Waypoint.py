...
"""autogenerated by genpy from pal_navigation_msgs/Waypoint.msg. Do not edit."""
import codecs
import sys
...
class Waypoint(genpy.Message):
  _md5sum = "d5a8fb3adda9ea0f94f6fbc1dd90ed69"
  _type = "pal_navigation_msgs/Waypoint"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """# Error codes
...
"""
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.actions = numpy.frombuffer(str[start:end], dtype=numpy.uint32, count=length)
      _x = self
      start = end
      end += 12
      (_x.pose.header.seq, _x.pose.header.stamp.secs, _x.pose.header.stamp.nsecs,) = _get_struct_3I().unpack(str[start:end])

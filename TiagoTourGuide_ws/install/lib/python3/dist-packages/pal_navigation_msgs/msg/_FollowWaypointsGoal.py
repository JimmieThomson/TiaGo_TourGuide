...
"""autogenerated by genpy from pal_navigation_msgs/FollowWaypointsGoal.msg. Do not edit."""
import codecs
import sys
...
class FollowWaypointsGoal(genpy.Message):
  _md5sum = "6ac0bba57c7ff0865644730bc6d43f52"
  _type = "pal_navigation_msgs/FollowWaypointsGoal"
...
"""
  ...
  __slots__ = ['goal_index','number_of_loops','bt_model_name','poses']
  _slot_types = ['uint32','uint32','string','pal_navigation_msgs/Waypoint[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       goal_index,number_of_loops,bt_model_name,poses
    ...
    if args or kwds:
      ...
      if self.goal_index is None:
        self.goal_index = 0
      if self.number_of_loops is None:
        self.number_of_loops = 0
      if self.bt_model_name is None:
        self.bt_model_name = ''
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_2I().pack(_x.goal_index, _x.number_of_loops))
      _x = self.bt_model_name
      length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.goal_index, _x.number_of_loops,) = _get_struct_2I().unpack(str[start:end])
      start = end
      end += 4
      ...
      if python3:
        self.bt_model_name = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.bt_model_name = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.poses = []

...
(cl:defmethod cl:initialize-instance :after ((m <Obstacle>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Obstacle)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pal_detection_msgs-msg:<Obstacle> is deprecated: use pal_detection_msgs-msg:Obstacle instead.")))

(cl:ensure-generic-function 'id-val :lambda-list '(m))
(cl:defmethod id-val ((m <Obstacle>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pal_detection_msgs-msg:id-val is deprecated.  Use pal_detection_msgs-msg:id instead.")
  (id m))
...
(cl:defmethod position_covariance-val ((m <Obstacle>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pal_detection_msgs-msg:position_covariance-val is deprecated.  Use pal_detection_msgs-msg:position_covariance instead.")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Obstacle>)))
  ...
  (cl:format cl:nil "int64 id~%~%geometry_msgs/Point position~%~%float64[4] position_covariance~%~%float32 width~%~%float32 height~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Obstacle)))
  "Returns full string definition for message of type 'Obstacle"
  (cl:format cl:nil "int64 id~%~%geometry_msgs/Point position~%~%float64[4] position_covariance~%~%float32 width~%~%float32 height~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%~%"))

...
class RecognizeObjectsFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new RecognizeObjectsFeedback(null);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new RecognizeObjectsFeedback(null);
    return resolved;
    }
};

module.exports = RecognizeObjectsFeedback;

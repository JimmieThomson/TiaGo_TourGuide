...
"""autogenerated by genpy from pal_navigation_msgs/FollowWaypointsActionResult.msg. Do not edit."""
import codecs
import sys
...
class FollowWaypointsActionResult(genpy.Message):
  _md5sum = "b3f8b40fcdd4d4d31b3c7bbbe616fa74"
  _type = "pal_navigation_msgs/FollowWaypointsActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','pal_navigation_msgs/FollowWaypointsResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = pal_navigation_msgs.msg.FollowWaypointsResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = pal_navigation_msgs.msg.FollowWaypointsResult()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      length = len(self.result.missed_waypoints)
      buff.write(_struct_I.pack(length))
      for val1 in self.result.missed_waypoints:
        _x = val1.index
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        self.result.missed_waypoints.append(val1)
      return self

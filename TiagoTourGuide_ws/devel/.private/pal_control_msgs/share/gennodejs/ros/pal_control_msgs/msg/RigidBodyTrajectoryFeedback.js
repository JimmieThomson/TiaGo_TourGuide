...
class RigidBodyTrajectoryFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new RigidBodyTrajectoryFeedback(null);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new RigidBodyTrajectoryFeedback(null);
    return resolved;
    }
};

module.exports = RigidBodyTrajectoryFeedback;

...
class LedProgressParams {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('led_offset')) {
        this.led_offset = initObj.led_offset
      }
      else {
        this.led_offset = 0.0;
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [led_offset]
    bufferOffset = _serializer.float32(obj.led_offset, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new LedProgressParams(null);
    ...
    // Deserialize message field [led_offset]
    data.led_offset = _deserializer.float32(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new LedProgressParams(null);
    ...
    if (msg.led_offset !== undefined) {
      resolved.led_offset = msg.led_offset;
    }
    else {
      resolved.led_offset = 0.0
    }
...
module.exports = LedProgressParams;

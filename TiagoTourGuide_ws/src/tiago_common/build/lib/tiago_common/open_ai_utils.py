...
class OpenAIUtils:
    ...
    def chat_completion(self, prompt, model=None, max_token=None):
       ...
       Provide output in valid JSON. Point_of_interest, concise_response, and closest are not ALLOWED in the content.
        Navigation: {'type': 'navigation', 'content': 'Rosie'} or {'type': 'navigation', 'content': 'Hologram'} or {'type': 'navigation', 'content': 'cobot arm'} or {'type': 'navigation', 'content': 'space lab'} or {'type': 'navigation', 'content': 'tiago'} or {'type': 'navigation', 'content': 'rosie light saber video'}
